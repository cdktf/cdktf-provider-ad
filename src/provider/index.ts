...
export class AdProvider extends cdktf.TerraformProvider {
  ...
  * @param importToId The construct id used in the generated config for the AdProvider to import
  * @param importFromId The id of the existing AdProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/ad/0.4.4/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the AdProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ad", importId: importFromId, provider });
      }
