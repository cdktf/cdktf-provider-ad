...
export class DataAdOu extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataAdOu to import
  * @param importFromId The id of the existing DataAdOu that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/ad/0.4.4/docs/data-sources/ou#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataAdOu to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "ad_ou", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ou_id: {
        value: cdktf.stringToHclTerraform(this._ouId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
