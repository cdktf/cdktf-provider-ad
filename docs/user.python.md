...
| <code><a href="#@cdktf/provider-ad.user.User.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-ad.user.User.toHclTerraform"></a>
