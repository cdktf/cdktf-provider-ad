...
| <code><a href="#@cdktf/provider-ad.gplink.Gplink.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-ad.gplink.Gplink.toHclTerraform"></a>
...
###### `move_target`<sup>Required</sup> <a name="move_target" id="@cdktf/provider-ad.gplink.Gplink.addMoveTarget.parameter.moveTarget"></a>
