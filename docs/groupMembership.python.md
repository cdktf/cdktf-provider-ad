...
| <code><a href="#@cdktf/provider-ad.groupMembership.GroupMembership.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-ad.groupMembership.GroupMembership.toHclTerraform"></a>
...
##### `move_to` <a name="move_to" id="@cdktf/provider-ad.groupMembership.GroupMembership.moveTo"></a>
